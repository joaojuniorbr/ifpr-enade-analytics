...
name: enade-projeto
description: >-
  Guia do Projeto Integrador ENADE Analytics (IFPR Pinhais). Usar ao editar
  marcos, modelo dimensional, Power BI, requisitos RF/RNF, LGPD/TCLE, dashboard
  ou qualquer entregável da disciplina de Business Intelligence.
---

# ENADE Analytics — skill do projeto
